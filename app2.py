...
if run:
    ...
    with col1:
        ...
        st.caption("Expected value represents the average reward in credits per game over a large number of simulations.")

        st.write(f"Standard deviation: {wins_o.std():.2f} credits")
        st.caption("Standard deviation measures how much results vary from the average reward and represents risk/volatility.")

        st.write(f"Minimum reward: {wins_o.min():.0f} credits")
        st.caption("Minimum reward represents the worst observed outcome in credits.")

        st.write(f"Maximum reward: {wins_o.max():.0f} credits")
        st.caption("Maximum reward represents the best observed outcome in credits.")
